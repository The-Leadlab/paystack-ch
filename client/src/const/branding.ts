...
export const BRAND_LOCKUP_ON_DARK_SRC = "/brand/paystack-lockup-on-dark-128.png" as const;
/** Mark for dark chrome. */
export const BRAND_MARK_ON_DARK_SRC = "/brand/paystack-mark-on-dark-128.png" as const;
...
export function brandMarkSrc(theme: "light" | "dark"): string {
  return theme === "dark" ? BRAND_MARK_ON_DARK_SRC : BRAND_LOGO_SRC;
}
