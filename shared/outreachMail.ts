...
export const OUTREACH_UPLOAD_DEMO_GIF_URL = "https://www.paystack.ch/outreach/upload-demo-v6.gif";
export const OUTREACH_UPLOAD_DEMO_PNG_URL = "https://www.paystack.ch/outreach/upload-demo-v6.png";
