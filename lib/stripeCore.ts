 ...
 *
 * Vercel guest checkout: **`api/stripe/guest-trial-checkout.ts`** only — JSON body may include
 * `stripeTest: true` for test mode. Keep in sync with `lib/stripeCore.ts` `runCreateCheckoutSessionGuest`.
 */
